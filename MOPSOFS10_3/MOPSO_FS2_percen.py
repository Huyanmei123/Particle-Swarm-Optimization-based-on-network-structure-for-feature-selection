...
# %%
# data_dir = utils.data_percen_dir
# result_dir = utils.result_dir
initial_dir = utils.initial_percen_dir
Dom_dir = utils.Dom_percen_dir
Gbest_dir = utils.Gbest_percen_dir
timeEstimation_dir = utils.timeEstimation_percen_dir
logpath = os.path.join(utils.log_dir, 'log-PSOFS10_3_Percen.txt')
